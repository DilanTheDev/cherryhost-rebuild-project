        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <Link to="#" className="text-white hover:text-lightning-400">
            ...
            <div className="mt-4 pt-4 border-t border-white/10">
              ...
              <iframe 
                ...
                title="LightningHost Server Status"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="#" className="text-white/70 hover:text-lightning-400">Minecraft Server Hosting</Link></li>
              <li><Link to="#" className="text-white/70 hover:text-lightning-400">Modpacks for Minecraft Server</Link></li>
              <li><Link to="#" className="text-white/70 hover:text-lightning-400">Minecraft Tools</Link></li>
            </ul>
          </div>
          ...
          <div>
            <h3 className="font-bold mb-4">LightningHost</h3>
            <ul className="space-y-2">
              <li><Link to="#" className="text-white/70 hover:text-lightning-400">Blog</Link></li>
              <li><Link to="#" className="text-white/70 hover:text-lightning-400">Careers</Link></li>
              <li><Link to="#" className="text-white/70 hover:text-lightning-400">Partnerships</Link></li>
              <li><Link to="#" className="text-white/70 hover:text-lightning-400">Privacy Policy</Link></li>
              <li><Link to="#" className="text-white/70 hover:text-lightning-400">Terms Of Service</Link></li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-white/10 mt-12 pt-6 text-center">
          <p className="text-white/50 text-sm">© 2025 LightningHost. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
